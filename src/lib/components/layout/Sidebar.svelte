	...
	>
		...
		>
			...
			<div>
				...
				<div class="">
					<Tooltip content={$i18n.t('Auto Flight Search')} placement="right">
						<a
							class=" cursor-pointer flex rounded-lg hover:bg-gray-100 dark:hover:bg-gray-850 transition group"
							href="/auto-flight-search"
							on:click={async (e) => {
								e.stopImmediatePropagation();
								e.preventDefault();

								goto('/auto-flight-search');
								itemClickHandler();
							}}
							draggable="false"
						>
				...
				<div class="">
					<Tooltip content={$i18n.t('Content Generator')} placement="right">
						<a
							class=" cursor-pointer flex rounded-lg hover:bg-gray-100 dark:hover:bg-gray-850 transition group"
			...
			<div class="pb-1.5">
				...
				<div class="px-[7px] flex justify-center text-gray-800 dark:text-gray-200">
					...
					>
						...
						<div class="flex self-center translate-y-[0.5px]">
							<div class=" self-center text-sm font-primary">{$i18n.t('Auto Flight Search')}</div>
						</div>
					</a>
				</div>
				...
				<div class="px-[7px] flex justify-center text-gray-800 dark:text-gray-200">
					...
					>
						...
						<div class="flex self-center translate-y-[0.5px]">
							<div class=" self-center text-sm font-primary">{$i18n.t('Post')}</div>
						</div>
					</a>
				</div>
