		...
		<div class="flex h-full">
			...
			<div class="w-1/2 p-6 border-r border-gray-200 dark:border-gray-700">
				<div class="max-w-lg mx-auto">
					<h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-8">Blog post</h1>
					...
					<!-- Post Button -->
					<button
						class="w-full bg-black hover:bg-gray-800 text-white font-medium py-3 px-4 rounded-lg transition"
					>
						Post
					</button>
				</div>
