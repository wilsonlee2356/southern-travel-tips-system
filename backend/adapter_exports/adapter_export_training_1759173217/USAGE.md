# canton-fixing-adapter - Adapter Usage Instructions

## Overview
This is a fine-tuned LoRA adapter for generating Cantonese travel content in JSON format.

## Adapter Information
- **Adapter Name**: canton-fixing-adapter
- **Base Model**: qwen2.5:14b
- **Created**: 2025-09-30 03:15:47
- **Session ID**: training_1759173217
...
- `training_training_1759173217.log` - Training log
- `training_info_training_1759173217.json` - Training configuration
