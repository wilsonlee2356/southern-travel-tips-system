# my-custom-adapter2 - Adapter Usage Instructions

## Overview
This is a fine-tuned LoRA adapter for generating Cantonese travel content in JSON format.

## Adapter Information
- **Adapter Name**: my-custom-adapter2
- **Base Model**: qwen2.5:14b
- **Created**: 2025-09-29 02:04:16
- **Session ID**: training_1759082482
...
- `training_training_1759082482.log` - Training log
- `training_info_training_1759082482.json` - Training configuration
